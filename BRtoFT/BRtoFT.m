...
for trllop = 1:length(trldat.eyedat)
    ...
    if trllop==1
        ...
        [Xs1, lag] = xcorr(eyedatNS2(1,lagind1:min([size(eyedatNS2,2) lagind2])), trldat.eyedat{trllop}(1,:));
        Xs2 = xcorr(eyedatNS2(2,lagind1:min([size(eyedatNS2,2) lagind2])), trldat.eyedat{trllop}(2,:));
        [~,Is1] = max(Xs1.*Xs2);
