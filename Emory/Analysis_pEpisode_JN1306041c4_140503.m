...
tag=['_pEpisode_Ch' num2str(chnlop) '_140503'];
resfil = strcat('C:\Users\michael.jutras\Documents\MATLAB\Virtual\FT data\',fid,tag,'.mat');

% save the results
save(resfil, 'Pm', 'pv', 'unionvector', 'trlind');
