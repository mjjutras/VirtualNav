...
% open the NS6 file, first channel, to get the sample count
NS6b = openNSx(fullfile(BRDir,[BRnam '.ns6']),'read','c:1');
...
NS6ts = NS6fs:NS6fs:(size(NS6b.Data,2)*NS6fs);
DECts = [nan(1,nonzer-1) NS6ts(nonzer):DECfs:(size(NS6b.Data,2)*NS6fs)];
