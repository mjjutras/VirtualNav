function YC1_electrode_report(pool)
...
%         cond1 = regionData.er < median(regionData.er);
%         cond2 = regionData.er >= median(regionData.er);
        for e = 1:length(regionData.tagNames)
           
            % tstats
            tLTA = regionData.statsLTA(e).tstat;
            tHTA = regionData.statsHTA(e).tstat;
            pLTA = regionData.statsLTA(e).p;
            pHTA = regionData.statsHTA(e).p;            
            
            % corr
            rLTA = regionData.rLTA(e);
            rLTA_pval = regionData.pLTA(e);
            rHTA = regionData.rHTA(e);
            rHTA_pval = regionData.pHTA(e);            
            
%             powG= regionData.powG(e);
%             powHFA = regionData.powHFA(e);
            keyboard
